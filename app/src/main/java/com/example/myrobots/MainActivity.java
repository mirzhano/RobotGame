    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGameOver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("robot1_victories", robot1.victories);
                intent.putExtra("robot2_victories", robot2.victories);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnEndGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, VictoryActivity.class);
                intent.putExtra("robot1_victories", robot1.getVictories());
                intent.putExtra("robot2_victories", robot2.getVictories());
                startActivity(intent);
            }
        });
